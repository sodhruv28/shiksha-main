        ...
        >
          <Row>
            ...
            <Col style={{ marginTop: "30px", marginLeft: "50px" }}>
              <Link to={"/addcourse"}>
                <Button
                  style={{ height: "30px", width: "140px", marginLeft: "50%" }}
                  variant="primary"
                >
                  Create Your Course
                </Button>
              ...
              <Col style={{ marginTop: "30px" }}>
                ...
                <Card.Text>
                  <h4 style={{ margin: "20px", fontSize: "15px" }}>
                    ...
                    complied resources and best practices to help you get to the
                ...
                <Card.Text>
                  <div>
                    <h5 style={{ marginTop: "20px", fontSize: "15px" }}>
                      ...
                      launch your first course faster! Eligible instructor who
                      publish their first course on time will receive a special
                      bonus to celebrate. Start today!
                    </h5>
                  </div>
                  <div>
                    <Card.Link style={{ marginLeft: "280px" }} href="#">
                      Get Started
                    </Card.Link>
                  </div>
                </Card.Text>
