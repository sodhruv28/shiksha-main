        ...
        <div class="card card-registration my-4">
          <div class="row g-0">
            <div class="col-xl-6 d-none d-xl-block">
               <img className= "border-top-left-radius: .25rem; border-bottom-left-radius: .25rem" style={{marginTop:"10px",height:"95%",width:"95%", marginLeft:"10px"}} src="\images\Mobile login-pana.png" />
            </div>
  ...
  <div class="centent" style={{margin:"20px"}}>
    <div class="centent__centainer">
      ...
      <ul class="centent__centainer__list">
        <li class="centent__centainer__list__item">Here !</li>
        <li class="centent__centainer__list__item">coders !</li>
        <li class="centent__centainer__list__item">users !</li>
        <li class="centent__centainer__list__item">Teachers</li>
      </ul>
    </div>
  </div>
</div>
